...
document.addEventListener("DOMContentLoaded", () => {
  addNeoCharacter(); // Add Neo and the instruction bubble after page load
  matrixEffect(); // Matrix rain effect for visual impact
  main.listener(); // Initialize the terminal functionality
});
